    ...
    public partial class MainFrm : MetroFramework.Forms.MetroForm
    {
        ...
        private void metroButton5_Click(object sender, EventArgs e)
        {
            ...
            int E = 0;
                ...
                {
                    //Presence count
                    p = (int)ada.GetDataByReport(dateTimePicker2.Value.Day, row[1].ToString(), "present").Rows[0][6];

                    // Absence
                    A = (int)ada.GetDataByReport(dateTimePicker2.Value.Day, row[1].ToString(), "absent").Rows[0][6];

                    // late
                    L = (int)ada.GetDataByReport(dateTimePicker2.Value.Day, row[1].ToString(), "late").Rows[0][6];


                    //Execuse
                    E = (int)ada.GetDataByReport(dateTimePicker2.Value.Day, row[1].ToString(), "excused").Rows[0][6];
        ...
        private void add_items(AutoCompleteStringCollection column)
        {
            column.Add("present");
            column.Add("absent");
            column.Add("late");
